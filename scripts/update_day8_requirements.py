"""Day 8 Dashboard Dependency를 requirements.txt에 중복 없이 추가한다."""
...
def main() -> None:
    ...
    if not missing_packages:
        print("[PASS] Day 8 Dashboard dependencies already exist")
        return

    updated_lines = list(original_lines)
    if updated_lines and updated_lines[-1].strip():
        updated_lines.append("")
    updated_lines.append("# Day 8 - Streamlit Image Inference Dashboard")
